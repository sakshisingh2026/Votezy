...
public class AuthController {
    ...
    private static final String ADMIN_EMAIL = "sakshisingh2157@gmail.com";
    private static final String ADMIN_PASSWORD = "Sakshi26@";
    private static final String ADMIN_FULL_NAME = "System Administrator- Sakshi Singh";
